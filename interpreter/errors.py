...
class SindhiBaseError(Exception):
    def __init__(self, error_name, details, line = None, column = None, code_string = None):
        self.error_name = error_name
        self.details = details
        self.line = None
        self.column = None
        self.code_string = None
        if line and column and code_string:
    ...
    def generate_message(self):
        ...
        if self.line and self.column and self.code_string:
...
class LikhaiJeGhalti(SindhiBaseError):
    def __init__(self, details, line = None, column = None, code_string = None):
